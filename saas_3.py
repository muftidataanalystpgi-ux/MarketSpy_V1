...
async def run_google_maps_scraper(keyword, status_ui):
    # Memastikan binary browser terinstal otomatis di runtime server Linux / Streamlit Cloud
    ...
    if start_button:
        if not input_keyword:
            ...
            if raw_results:
                ...
                pd_st.error("Pencarian gagal. Google Maps tidak mengembalikan hasil atau element error.")
